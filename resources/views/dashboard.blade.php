                ...
                <ul class="nav metismenu" id="side-menu" style="">
                    ...
                    <li class="active">
                        ...
                        <ul class="nav nav-second-level collapse in">
                            <li class="active"><a href="dashboard_2.html">Rotator Management</a></li>
                            <li><a href="dashboard_3.html">Admin Profile</a></li>
                        </ul>
                    </li>
            ...
            <div class="row border-bottom">
                <nav class="navbar navbar-static-top white-bg" role="navigation" style="margin-bottom: 0">
                    ...
                    <ul class="nav navbar-top-links navbar-right">
                        <li>
                            <span class="m-r-sm text-muted welcome-message">Welcome to <b>Opendoorz</b> Admin System.</span>
                        </li>
                        <li class="dropdown">
